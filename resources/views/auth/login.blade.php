...
<head>
    ...
    <title>Login - UD Wijaya Kerupuk</title>
    <meta name="description" content="Sistem Keuangan UD Wijaya Kerupuk" />
...
<body>
                    ...
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center mb-4">
                            <a href="#" class="app-brand-link gap-2">
                                ...
                                <span class="app-brand-text demo text-body fw-bolder">Wijaya Kerupuk</span>
                            </a>
                        </div>
                        <!-- /Logo -->

                        <h4 class="mb-2 text-center">Selamat Datang! 👋</h4>
                        <p class="mb-4 text-center">Silakan login ke sistem keuangan UD Wijaya Kerupuk</p>
                        ...
                        <p class="text-center">
                            <span class="text-muted">UD Wijaya Kerupuk © {{ date('Y') }}</span>
                        </p>
                    </div>
                </div>
                <!-- /Login Card -->
    ...
    <script>
        ...
        document.querySelectorAll('.form-password-toggle').forEach(toggle => {
